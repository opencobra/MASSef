...
(metabolite["dhap", "c"]*(rateconst["FBA11", False]*
    (metabolite["g3p", "c"]*rateconst["FBA14", False]*
      (rateconst["FBA15", False] + rateconst["FBA15", True])*
      rateconst["FBA18", False] + (rateconst["FBA14", False] + 
    ...
    (metabolite["g3p", "c"]*rateconst["FBA16", False]*
      (rateconst["FBA17", False] + rateconst["FBA17", True])*
      rateconst["FBA19", False] + (rateconst["FBA16", False] + 
 ...
 (rateconst["FBA11", False]*(rateconst["FBA12", False]*
  ...
  metabolite["cit", "c"]*rateconst["FBA11", True]*
   ...
   (rateconst["FBA13", False]*rateconst["FBA16", True]*
     rateconst["FBA17", False] + metabolite["g3p", "c"]*
    ...
    rateconst["FBA16", True]*rateconst["FBA17", True]*
     ...
     rateconst["FBA16", False]*(metabolite["g3p", "c"]*
       (rateconst["FBA17", False] + rateconst["FBA17", True])*
       rateconst["FBA19", False] + rateconst["FBA17", True]*
       rateconst["FBA19", True] + rateconst["FBA13", False]*
       (rateconst["FBA17", False] + metabolite["g3p", "c"]*
         rateconst["FBA19", False] + rateconst["FBA19", True]))))
