...
{enzyme[{"ID" -> "TPI", "Compartment" -> "c", "BoundCatalytic" -> {}, 
  ...
  -((-(parameter["TPI_total"]*rateconst["TPI1", False]*
    ...
    (metabolite["dhap", "c"]*rateconst["TPI1", False]*
      ...
      rateconst["TPI2", True] + metabolite["g3p", "c"]*
      rateconst["TPI1", True]*rateconst["TPI2", True] + 
     rateconst["TPI1", False]*rateconst["TPI3", False] + 
     metabolite["g3p", "c"]*rateconst["TPI1", True]*
      rateconst["TPI3", False] + metabolite["dhap", "c"]*
      rateconst["TPI2", False]*rateconst["TPI3", False] + 
     metabolite["g3p", "c"]*rateconst["TPI1", True]*rateconst["TPI3", True] + 
 ...
 enzyme[{"ID" -> "TPI", "Compartment" -> "c", "BoundCatalytic" -> 
    ...
    "CatalyticSites" -> Infinity, "ActivationSites" -> 0, 
    "InhibitionSites" -> 0}] -> 
  -((-(metabolite["dhap", "c"]*parameter["TPI_total"]*
       rateconst["TPI1", False]*rateconst["TPI2", False]) - 
     metabolite["g3p", "c"]*parameter["TPI_total"]*rateconst["TPI1", True]*
      rateconst["TPI3", True] - metabolite["dhap", "c"]*
