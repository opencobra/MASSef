...
(4*metabolite["r5p", "c"]*metabolite["xu5p__D", "c"]*parameter["TKT1_total"]*
  rateconst["TKT11", True]*rateconst["TKT12", True]*rateconst["TKT13", True]*
  rateconst["TKT14", True]*rateconst["TKT15", True]*rateconst["TKT16", True])/
