...
(metabolite["nadph", "c"]*(metabolite["co2", "c"]*rateconst["GND1", False]*
    rateconst["GND3", False]*rateconst["GND4", False]*
    rateconst["GND5", False]*rateconst["GND6", False] + 
   metabolite["co2", "c"]*metabolite["ru5p__D", "c"]*rateconst["GND2", False]*
    rateconst["GND3", False]*rateconst["GND4", False]*
    rateconst["GND5", False]*rateconst["GND6", False] + 
   ...
   metabolite["ru5p__D", "c"]*rateconst["GND1", False]*
    rateconst["GND2", False]*(metabolite["co2", "c"]*rateconst["GND4", False]*
      (rateconst["GND5", False] + rateconst["GND5", True])*
      rateconst["GND6", False] + (rateconst["GND4", False] + 
