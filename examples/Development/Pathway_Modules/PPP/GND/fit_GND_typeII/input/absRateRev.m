...
(2*metabolite["co2", "c"]*metabolite["nadph", "c"]*metabolite["ru5p__D", "c"]*
  parameter["GND_total"]*rateconst["GND1", False]*rateconst["GND2", False]*
  rateconst["GND3", False]*rateconst["GND4", False]*rateconst["GND5", False]*
  rateconst["GND6", False])/(rateconst["GND1", False]*rateconst["GND2", True]*
   rateconst["GND3", False]*rateconst["GND4", True]*
   rateconst["GND5", False] + metabolite["co2", "c"]*rateconst["GND1", False]*
   rateconst["GND2", True]*rateconst["GND3", False]*rateconst["GND5", False]*
   rateconst["GND6", False] + rateconst["GND1", False]*
   rateconst["GND2", True]*rateconst["GND3", False]*rateconst["GND4", True]*
   rateconst["GND6", True] + rateconst["GND1", False]*rateconst["GND2", True]*
   rateconst["GND4", True]*rateconst["GND5", True]*rateconst["GND6", True] + 
  metabolite["ru5p__D", "c"]*rateconst["GND1", False]*
   rateconst["GND2", False]*(metabolite["co2", "c"]*rateconst["GND3", False]*
