...
(4*metabolite["e4p", "c"]*metabolite["pep", "c"]*parameter["DDPA_total"]*
  rateconst["DDPA1", True]*rateconst["DDPA2", True]*rateconst["DDPA3", True]*
  rateconst["DDPA4", True]*rateconst["DDPA5", True]*
  (rateconst["DDPA_Kic_2pg_1_pep", False] + rateconst["DDPA_Kincc_2pg_1_pep", 
  ...
  rateconst["DDPA4", True]*rateconst["DDPA5", True]*
   ...
   rateconst["DDPA4", True]*(rateconst["DDPA_Kic_2pg_1_pep", False]*
     (rateconst["DDPA1", False]*rateconst["DDPA3", False]*
       rateconst["DDPA_Kincu_2pg_1_e4p", False] + metabolite["pep", "c"]*
       rateconst["DDPA1", True]*(rateconst["DDPA3", False] + 
        metabolite["e4p", "c"]*rateconst["DDPA3", True])*
       rateconst["DDPA_Kincu_2pg_1_e4p", False] + metabolite["2pg", "c"]*
       metabolite["e4p", "c"]*metabolite["pep", "c"]*rateconst["DDPA1", True]*
       rateconst["DDPA3", True]*rateconst["DDPA_Kincu_2pg_1_e4p", True])*
     rateconst["DDPA_NC_2pg", False] + rateconst["DDPA_Kincc_2pg_1_pep", 
