...
(2*metabolite["3pg", "c"]*metabolite["atp", "c"]*parameter["PGK_total"]*
  ...
  rateconst["PGK9", False])/(rateconst["PGK1", False]*
   rateconst["PGK2", False]*(metabolite["atp", "c"]*
  ...
  metabolite["3pg", "c"]^2*rateconst["PGK4", False]*rateconst["PGK7", False]*
   (rateconst["PGK1", False]*rateconst["PGK2", False]*
