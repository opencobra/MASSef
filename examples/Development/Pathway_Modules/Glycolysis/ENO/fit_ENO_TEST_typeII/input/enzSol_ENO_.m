...
{enzyme[{"ID" -> "ENO", "Compartment" -> "c", "BoundCatalytic" -> {}, 
    ...
    "InhibitionSites" -> 0}] -> 
  -((-(parameter["ENO_total"]*rateconst["ENO1", False]*
       rateconst["ENO2", True]) - parameter["ENO_total"]*
      rateconst["ENO1", False]*rateconst["ENO3", False] - 
     parameter["ENO_total"]*rateconst["ENO2", True]*rateconst["ENO3", True])/
 ...
 enzyme[{"ID" -> "ENO", "Compartment" -> "c", "BoundCatalytic" -> 
    ...
    "BoundInhibitors" -> {}, "CatalyticSites" -> Infinity, 
    "ActivationSites" -> 0, "InhibitionSites" -> 0}] -> 
  -((-(metabolite["pep", "c"]*parameter["ENO_total"]*rateconst["ENO1", False]*
       rateconst["ENO2", False]) - metabolite["2pg", "c"]*
      parameter["ENO_total"]*rateconst["ENO1", True]*
      rateconst["ENO3", True] - metabolite["pep", "c"]*parameter["ENO_total"]*
      rateconst["ENO2", False]*rateconst["ENO3", True])/
    (metabolite["pep", "c"]*rateconst["ENO1", False]*
      rateconst["ENO2", False] + rateconst["ENO1", False]*
      rateconst["ENO2", True] + metabolite["2pg", "c"]*
      rateconst["ENO1", True]*rateconst["ENO2", True] + 
