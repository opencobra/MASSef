...
(metabolite["pyr", "c"]*(metabolite["atp", "c"]*rateconst["PPS1", True]*
    rateconst["PPS3", True]*rateconst["PPS4", True]*rateconst["PPS5", True]*
    rateconst["PPS6", True] + metabolite["atp", "c"]*rateconst["PPS2", True]*
    rateconst["PPS3", True]*rateconst["PPS4", True]*rateconst["PPS5", True]*
    rateconst["PPS6", True] + rateconst["PPS1", False]*
    rateconst["PPS2", True]*rateconst["PPS4", True]*
    (rateconst["PPS5", True]*rateconst["PPS6", True] + 
     rateconst["PPS3", False]*(rateconst["PPS5", False] + 
       rateconst["PPS6", True])) + rateconst["PPS1", True]*
