...
(metabolite["amp", "c"]*(metabolite["pi", "c"]*rateconst["PPS1", False]*
   ...
   metabolite["pep", "c"]*rateconst["PPS1", False]*rateconst["PPS2", False]*
    (metabolite["pi", "c"]*rateconst["PPS4", False]*
      (rateconst["PPS5", False] + rateconst["PPS5", True])*
      rateconst["PPS6", False] + (rateconst["PPS4", False] + 
       rateconst["PPS4", True])*rateconst["PPS5", True]*
      rateconst["PPS6", True] + rateconst["PPS3", False]*
      (metabolite["pi", "c"]*rateconst["PPS5", False]*rateconst["PPS6", 
         False] + rateconst["PPS4", True]*(rateconst["PPS5", False] + 
         rateconst["PPS6", True]) + rateconst["PPS4", False]*
        (rateconst["PPS5", False] + metabolite["pi", "c"]*
          rateconst["PPS6", False] + rateconst["PPS6", True])))))/
