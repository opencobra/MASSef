...
(4*metabolite["g3p", "c"]*metabolite["nad", "c"]*metabolite["pi", "c"]*
  parameter["GAPD_total"]*rateconst["GAPD1", True]*rateconst["GAPD2", True]*
  rateconst["GAPD3", True]*rateconst["GAPD4", True]*rateconst["GAPD5", True]*
  rateconst["GAPD6", True])/(metabolite["g3p", "c"]*metabolite["pi", "c"]*
   rateconst["GAPD2", True]*rateconst["GAPD3", True]*rateconst["GAPD4", True]*
