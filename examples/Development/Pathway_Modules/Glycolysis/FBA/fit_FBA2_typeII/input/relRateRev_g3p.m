...
(metabolite["g3p", "c"]*(metabolite["g3p", "c"]*
   ...
   rateconst["FBA21", False]*(rateconst["FBA2_Kincu_g3p_1_fdp", False] + 
  ...
  ((rateconst["FBA2_Kincc_g3p_1_fdp", False] + 
    ...
    (rateconst["FBA23", True]*rateconst["FBA24", True]*
      ...
      rateconst["FBA2_Kincu_g3p_1_fdp", True]*rateconst["FBA2_NC_g3p", 
       False] + rateconst["FBA23", False]*rateconst["FBA2_Kic_dhap_1_fdp", 
      ...
      (rateconst["FBA22", True]*(rateconst["FBA23", False] + 
       ...
       rateconst["FBA2_NC_g3p", False])) + metabolite["dhap", "c"]*
    ...
    (rateconst["FBA21", False]*(rateconst["FBA23", False] + 
     ...
     rateconst["FBA23", False]*(rateconst["FBA24", False]*
        ...
        rateconst["FBA2_Kincu_g3p_1_fdp", True]*rateconst["FBA2_NC_g3p", 
         False] + rateconst["FBA24", False]*rateconst["FBA2_Kincc_g3p_1_fdp", 
         False]*(rateconst["FBA2_Kincu_g3p_1_fdp", False] + 
         rateconst["FBA2_Kincu_g3p_1_fdp", True] + rateconst["FBA2_NC_g3p", 
          False])))))/((rateconst["FBA2_Kincu_g3p_1_fdp", True]*
    rateconst["FBA2_NC_g3p", False] + rateconst["FBA21", False]*
    ...
    (rateconst["FBA23", True]*rateconst["FBA24", True]*
      ...
      (rateconst["FBA2_Kincc_g3p_1_fdp", False]*rateconst["FBA2_NC_g3p", 
       ...
       False]*(rateconst["FBA23", False]*rateconst["FBA2_Kincu_g3p_1_fdp", 
         True]*rateconst["FBA2_NC_g3p", False] + rateconst["FBA24", True]*
        rateconst["FBA2_Kincu_g3p_1_fdp", True]*rateconst["FBA2_NC_g3p", 
