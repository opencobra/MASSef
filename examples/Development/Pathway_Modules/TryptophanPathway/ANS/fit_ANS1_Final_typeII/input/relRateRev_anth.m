...
(metabolite["anth", "c"]*(rateconst["ANS1", False]*
    (rateconst["ANS2", False] + rateconst["ANS2", True])*
   ...
   metabolite["pyr", "c"]*rateconst["ANS4", False]*
    (rateconst["ANS1", False]*(metabolite["glu__L", "c"]*
       ...
       False] + metabolite["glu__L", "c"]*rateconst["ANS2", False]*
      rateconst["ANS3", False]*rateconst["ANS5", False]*
