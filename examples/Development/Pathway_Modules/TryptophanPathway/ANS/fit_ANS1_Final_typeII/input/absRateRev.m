...
(2*metabolite["anth", "c"]*metabolite["glu__L", "c"]*metabolite["pyr", "c"]*
  parameter["ANS_total"]*rateconst["ANS1", False]*rateconst["ANS2", False]*
  rateconst["ANS3", False]*rateconst["ANS4", False]*rateconst["ANS5", False]*
