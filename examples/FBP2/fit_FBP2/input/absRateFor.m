...
(2*metabolite["fdp", "c"]^2*parameter["FBP2_total"]*rateconst["FBP21", True]*
  rateconst["FBP22", True]*rateconst["FBP23", True]*rateconst["FBP24", True]*
  rateconst["FBP25", True]*rateconst["FBP26", True]*rateconst["FBP27", True])/
