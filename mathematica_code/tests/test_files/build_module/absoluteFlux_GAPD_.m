...
parameter["v", "GAPD"] -> (parameter["GAPD_total"]*parameter["Volume", "c"]*
   rateconst["GAPD6", False]*
   (-(metabolite["13dpg", "c"]*metabolite["nadh", "c"]*
     ...
     (-((rateconst["GAPD2", True] + metabolite["nadh", "c"]*
          rateconst["GAPD4", False])*rateconst["GAPD6", True]) + 
      ((metabolite["nadh", "c"]*rateconst["GAPD4", False]*
          rateconst["GAPD6", False] + rateconst["GAPD2", True]*
          (rateconst["GAPD4", True] + rateconst["GAPD6", False]))*
        rateconst["GAPD6", True])/rateconst["GAPD6", False])))/
  (metabolite["nad", "c"]*rateconst["GAPD1", True]*rateconst["GAPD2", True]*
    ...
    rateconst["GAPD3", True]*rateconst["GAPD4", True]*
    rateconst["GAPD5", True] + metabolite["nad", "c"]*
    rateconst["GAPD1", True]*rateconst["GAPD2", True]*
   ...
   metabolite["g3p", "c"]*metabolite["nad", "c"]*metabolite["nadh", "c"]*
    ...
    rateconst["GAPD3", True]*rateconst["GAPD5", True]*
    rateconst["GAPD6", False] + metabolite["g3p", "c"]*metabolite["nad", "c"]*
    metabolite["nadh", "c"]*metabolite["pi", "c"]*rateconst["GAPD1", True]*
   ...
   metabolite["g3p", "c"]*metabolite["nad", "c"]*metabolite["pi", "c"]*
    ...
    (metabolite["nadh", "c"]*rateconst["GAPD3", False]*
      rateconst["GAPD4", False]*rateconst["GAPD5", False]*
      rateconst["GAPD6", False] + rateconst["GAPD2", True]*
    ...
    rateconst["GAPD2", False]*(rateconst["GAPD1", False]*
      rateconst["GAPD3", False]*rateconst["GAPD4", True]*
      ...
      rateconst["GAPD1", False]*rateconst["GAPD4", True]*
      rateconst["GAPD5", True]*rateconst["GAPD6", True] + 
     metabolite["g3p", "c"]*metabolite["pi", "c"]*rateconst["GAPD3", True]*
      rateconst["GAPD4", True]*rateconst["GAPD5", True]*
